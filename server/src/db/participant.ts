...
export const createParticipant = (values: CreateParticipantDto) => new ParticipantModel(values).save().then((participant) => participant.toObject()).catch(err => console.log(err));
